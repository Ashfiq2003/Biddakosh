...
public class Skills extends JFrame implements ActionListener{
    ...
    JButton offrsbutton , studymat, cocont, Profile,bh5, bh6,bh7,  lh2, bh8, bh9,buttab , bh10, bh11, butta1,butta2, butta3, butta4, butta5, butta6, butta7,bbback;
    JComboBox combo;
    ImageIcon ACcour1  ;

    public Skills(){
            super("Skills Course-বিদ্যাকোষ");
...
Ptop.add(Profile);
   ...
   AcCourse = new JLabel("<html><b><u>Skill Development Courses</u></b></html>");
   AcCourse.setFont(new Font("Roboto" ,Font.BOLD, 25 ));
   AcCourse.setBounds(210, 8,350,30);
   ...
   //AcCourse.setBorder(border);
    ...
    butta5.setBounds(120, 80,180,120);
 ...
 Pfront.add(bh8);
    ...
    butta6.setBounds(420, 80,180,120);
    Pfront.add(butta6);
 ...
 ImageIcon bookp = new ImageIcon("D:\\Final_Biddakosh\\C1.jpg");
 buttab = new JButton(bookp);
 buttab.addActionListener(this);
 buttab.setBounds(420, 80,180,120);
 Pfront.add(buttab);
