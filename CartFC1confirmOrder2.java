...
public class CartFC1confirmOrder2 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     LMycart.setBackground(Color.decode("#5478E4"));
      Pfront.add(LMycart);
        ...
        ImageIcon minicourse = new ImageIcon("D:\\Final_Biddakosh\\ICT Small.png");
         conl = new JLabel( minicourse);
       conl.setBounds(50, 110,120,70);
        Pfront.add(conl);

        cl1 = new JLabel("<html><p>HSC ICT<br>Tk. 500</p></html>");
       ...
       ttt = new JLabel("<html><p align='left'><b>500/-</b></html>");
...
Pfront.add(bbback);
    ...
    public void actionPerformed(ActionEvent ae)
    {
      if(ae.getSource()==pay )
			{  
        PaymentCourse2 qq = new PaymentCourse2();
        qq .show();
				qq .setVisible(false);
				qq .setVisible(true);
