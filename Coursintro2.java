...
public class Coursintro2 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     mn.setBackground(Color.decode("#5478E4"));
      ...
      mc = new JLabel("<html><p>Angellina Laurence<br>Teacher, Biddakosh</p></html>");
      ...
      mc.setBackground(Color.decode("#5478E4"));
       ...
       conl.setBounds(50, 90,60,60);
        ...
        ImageIcon cora1 = new ImageIcon("D:\\Final_Biddakosh\\HSC ICT BIddakosh Big.png");
       ...
       coo1.setBounds(30, 20,180,120);
        ...
        ckl = new JLabel("<html><s>1000/-</s><font face='Tahoma'" + " color=red>  500/-</font></html>");
        ...
        ckp = new JLabel("<html><ul type='disc'><li>Time needed 60 hours<li>30 Videos<li>40 Notes<li>2 Quizzes</ul></html>");
