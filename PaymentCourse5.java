...
public class PaymentCourse5 extends JFrame implements ActionListener{
...
Appvar = new JButton("PAY TK. 8500.00");
    ...
    public void actionPerformed(ActionEvent ae)
    {
      if (ae.getActionCommand().equals("")) {
        System.out.println( group.getSelection().getActionCommand());
                 ...
                 if(ae.getSource()==Appvar )
                 {  
                   Coursevid5 koolp= new Coursevid5();
                   koolp.show();
                   koolp.setVisible(false);
                   koolp.setVisible(true);
                    }
