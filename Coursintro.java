...
public class Coursintro extends JFrame implements ActionListener{
     ...
     mn.setBackground(Color.decode("#5478E4"));
      ...
      mc.setBackground(Color.decode("#5478E4"));
       ...
       conl.setBounds(50, 90,60,60);
        ...
        ImageIcon cora1 = new ImageIcon("D:\\Final_Biddakosh\\C1.jpg");
       ...
       coo1.setBounds(30, 20,180,120);
        ...
        ckp = new JLabel("<html><ul type='disc'><li>Time needed 2 hours<li>300 Videos<li>500 Notes<li>2 Quizzes</ul></html>");
        ckp.setFont(new Font("Roboto" ,Font.BOLD, 15 ));
