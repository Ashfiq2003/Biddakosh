...
public class CartFC1confirmOrder extends JFrame implements ActionListener{
     ...
     LMycart.setBackground(Color.decode("#5478E4"));
      Pfront.add(LMycart);
       ...
       conl.setBounds(50, 110,120,70);
        ...
        cl1 = new JLabel("<html><p>HSC Physics<br>500/-<br><font face='Tahoma'" + " color=yellow>  800/-</font></p></html>");
