...
public class CartFC1confirmOrder5 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     LMycart.setBackground(Color.decode("#5478E4"));
      Pfront.add(LMycart);
        ...
        ImageIcon minicourse = new ImageIcon("D:\\Final_Biddakosh\\C1int.png");
         conl = new JLabel( minicourse);
       conl.setBounds(50, 110,120,70);
        Pfront.add(conl);

        cl1 = new JLabel("<html><p>C++ Advance<br>Tk. 8500</p></html>");
       ...
       ttt = new JLabel("<html><p align='left'><b>8500/-</b></html>");
...
Pfront.add(bbback);
    ...
    public void actionPerformed(ActionEvent ae)
    {
      ...
      if(ae.getSource()==bbback )
        ...
        clyu .show();
        clyu  .setVisible(false);
        clyu  .setVisible(true);
            
         }
      if(ae.getSource()==pay )
			{  
        PaymentCourse5 tol = new PaymentCourse5();
        tol.show();
