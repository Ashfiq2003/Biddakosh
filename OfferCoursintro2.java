...
public class OfferCoursintro2 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     LMycart = new JLabel("Data Entry Freelancing");
     LMycart.setFont(new Font("Roboto" ,Font.BOLD, 25 ));
     LMycart.setBounds(50, 30,320,30);
     ...
     mn.setBackground(Color.decode("#5478E4"));
      ...
      mc = new JLabel("<html><p>Ruchita Bourel <br>Teacher, Biddakosh</p></html>");
      ...
      mc.setBackground(Color.decode("#5478E4"));
       ...
       lo.setBackground(Color.decode("#5478E4"));
        ...
        lol = new JLabel("<html><ul type='disc'><li>You can do Effective Earning<li>Justify yourself very easily<li>Earn an Idea about Freelancing</ul></html> ");
       ...
       coo1.setBounds(30, 20,180,120);
        ...
        ckl = new JLabel("<html><s>18000/-</s><font face='Tahoma'" + " color=red>  Free</font></html>");
        ...
        ckp = new JLabel("<html><ul type='disc'><li>Time needed 70 hours<li>70 Videos<li>25 Notes<li>10 Quizzes</ul></html>");
