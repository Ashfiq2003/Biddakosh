...
public class OfferCoursintro1 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     LMycart = new JLabel("Export Import From China");
     ...
     mn.setBackground(Color.decode("#5478E4"));
      ...
      mc = new JLabel("<html><p>Rotia Stain <br>Teacher, Biddakosh</p></html>");
      ...
      mc.setBackground(Color.decode("#5478E4"));
       ...
       lo.setBackground(Color.decode("#5478E4"));
        ...
        lol = new JLabel("<html><ul type='disc'><li>You can do Effective Business<li>Justify yourself very easily<li>Earn an Idea about business</ul></html> ");
       ...
       coo1.setBounds(30, 20,180,120);
        ...
        ckl = new JLabel("<html><s>10000/-</s><font face='Tahoma'" + " color=red>  Free</font></html>");
        ...
        ckp = new JLabel("<html><ul type='disc'><li>Time needed 100 hours<li>50 Videos<li>20 Notes<li>20 Quizzes</ul></html>");
