...
public class PaymentCourse4 extends JFrame implements ActionListener{
...
Appvar = new JButton("PAY TK. 9500.00");
    ...
    public void actionPerformed(ActionEvent ae)
    {
      if (ae.getActionCommand().equals("")) {
        System.out.println( group.getSelection().getActionCommand());
                 ...
                 if(ae.getSource()==Appvar )
                 {  
                   Coursevid4 uiopo= new Coursevid4();
                   uiopo.show();
                   uiopo.setVisible(false);
                   uiopo.setVisible(true);
                    }
