...
public class Coursintro1 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     LMycart = new JLabel("HSC Physics");
     ...
     mn.setBackground(Color.decode("#5478E4"));
      ...
      mc = new JLabel("<html><p>Carman J Lamagna <br>Founder, Biddakosh</p></html>");
      ...
      mc.setBackground(Color.decode("#5478E4"));
       ...
       lo.setBackground(Color.decode("#5478E4"));
        ...
        lol = new JLabel("<html><ul type='disc'><li>You can solve critical Academic problems<li>Justify yourself very easily<li>Earn an Idea about Question Pattern</ul></html> ");
       ...
       conl.setBounds(50, 90,60,60);
        ...
        ImageIcon cora1 = new ImageIcon("D:\\Final_Biddakosh\\HSC Physics big.png");
       ...
       coo1.setBounds(30, 20,180,120);
        ...
        ckl = new JLabel("<html><s>1500/-</s><font face='Tahoma'" + " color=red>  800/-</font></html>");
        ...
        ckp = new JLabel("<html><ul type='disc'><li>Time needed 450 hours<li>380 Videos<li>120 Notes<li>100 Quizzes</ul></html>");
      ...
      if(ae.getSource()== bbback)
        ...
        h.show();
         ...
         {  
          ...
          CartFC1confirmOrder1 cccvb = new CartFC1confirmOrder1();
          cccvb.show();
          this.setVisible(false);
          cccvb.setVisible(true);
            }
