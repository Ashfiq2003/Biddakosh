...
public class CartFC1confirmOrder6 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     LMycart.setBackground(Color.decode("#5478E4"));
      Pfront.add(LMycart);
        ...
        ImageIcon minicourse = new ImageIcon("D:\\Final_Biddakosh\\OOP 1 Java small.png");
         conl = new JLabel( minicourse);
       conl.setBounds(50, 110,120,70);
        Pfront.add(conl);

        cl1 = new JLabel("<html><p>OPP1 [JAVA]<br>Tk. 15000</p></html>");
       ...
       ttt = new JLabel("<html><p align='left'><b>15000/-</b></html>");
    ...
    public void actionPerformed(ActionEvent ae)
    {
      if(ae.getSource()==bbback )
        ...
        coll .setVisible(true);
         ...
         if(ae.getSource()==pay )
         {  
          PaymentCourse6 rty = new PaymentCourse6();
          rty.show();
          rty.setVisible(false);
          rty.setVisible(true);
