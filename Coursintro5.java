...
public class Coursintro5 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     mn.setBackground(Color.decode("#5478E4"));
      ...
      mc = new JLabel("<html><p>Jack Son <br>Teacher, Biddakosh</p></html>");
      ...
      mc.setBackground(Color.decode("#5478E4"));
       ...
       coo1.setBounds(30, 20,180,120);
        ...
        ckl = new JLabel("<html><s>18000/-</s><font face='Tahoma'" + " color=red>  8500/-</font></html>");
        ...
        ckp = new JLabel("<html><ul type='disc'><li>Time needed 70 hours<li>14 Videos<li>15 Notes<li>15 Quizzes</ul></html>");
...
Pfront.add(bbback);
    ...
    public void actionPerformed(ActionEvent ae)
    {
      if(ae.getSource()==Enrl )
			{  
        CartFC1confirmOrder5 fop = new CartFC1confirmOrder5();
        fop.show();
