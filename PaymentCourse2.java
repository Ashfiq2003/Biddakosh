...
public class PaymentCourse2 extends JFrame implements ActionListener{
...
Appvar = new JButton("PAY TK. 500.00");
    ...
    public void actionPerformed(ActionEvent ae)
    {
      if (ae.getActionCommand().equals("")) {
        System.out.println( group.getSelection().getActionCommand());
                 ...
                 if(ae.getSource()==Appvar ){
                 Coursevid2 iop= new Coursevid2();
                 iop.show();
                 iop.setVisible(false);
                 iop.setVisible(true);
                  }
