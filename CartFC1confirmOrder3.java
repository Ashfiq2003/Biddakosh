...
public class CartFC1confirmOrder3 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     LMycart.setBackground(Color.decode("#5478E4"));
      Pfront.add(LMycart);
        ...
        ImageIcon minicourse = new ImageIcon("D:\\Final_Biddakosh\\Medical Admission Small.png");
         conl = new JLabel( minicourse);
       conl.setBounds(50, 110,120,70);
        Pfront.add(conl);

        cl1 = new JLabel("<html><p>Medical Admission<br>Tk. 5000</p></html>");
       ...
       ttt = new JLabel("<html><p align='left'><b>5000/-</b></html>");
...
Pfront.add(bbback);
    ...
    public void actionPerformed(ActionEvent ae)
    {
      if(ae.getSource()==pay )
			{  
        PaymentCourse3 ty = new PaymentCourse3();
        ty .show();
				ty .setVisible(false);
				ty.setVisible(true);
