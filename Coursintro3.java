...
public class Coursintro3 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     LMycart = new JLabel("Medical Admission");
     ...
     mn.setBackground(Color.decode("#5478E4"));
      ...
      mc = new JLabel("<html><p>Elsa Jemi <br>Teacher, Biddakosh</p></html>");
      ...
      mc.setBackground(Color.decode("#5478E4"));
       ...
       lo.setBackground(Color.decode("#5478E4"));
        ...
        lol = new JLabel("<html><ul type='disc'><li>You can solve critical Admission problems<li>Justify yourself very easily<li>Earn an Idea about Question Pattern</ul></html> ");
        lol.setFont(new Font("Roboto" ,Font.BOLD, 15 ));
        lol.setBounds(10, 190,500,150);
       ...
       conl.setBounds(50, 90,60,60);
        ...
        ImageIcon cora1 = new ImageIcon("D:\\Final_Biddakosh\\Medical Big.png");
       ...
       coo1.setBounds(30, 20,180,120);
        ...
        ckl = new JLabel("<html><s>10000/-</s><font face='Tahoma'" + " color=red>  5000/-</font></html>");
        ...
        ckp = new JLabel("<html><ul type='disc'><li>Time needed 220 hours<li>340 Videos<li>50 Notes<li>2 Quizzes</ul></html>");
        ckp.setFont(new Font("Roboto" ,Font.BOLD, 13 ));
        ckp.setBounds(0, 150,200,200);
...
Pfront.add(bbback);
    ...
    public void actionPerformed(ActionEvent ae)
    {
      if(ae.getSource()==Enrl )
			{  
        CartFC1confirmOrder3 cchop = new CartFC1confirmOrder3();
        cchop.show();
				this.setVisible(false);
				cchop.setVisible(true);
