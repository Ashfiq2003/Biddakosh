...
public class Coursintro4 extends JFrame implements ActionListener{
...
Ptop.add(Profile);
     ...
     mn.setBackground(Color.decode("#5478E4"));
      ...
      mc = new JLabel("<html><p>Riota jesica <br>Teacher, Biddakosh</p></html>");
      ...
      mc.setBackground(Color.decode("#5478E4"));
       ...
       conl.setBounds(50, 90,60,60);
        ...
        ImageIcon cora1 = new ImageIcon("D:\\Final_Biddakosh\\Engineering Admission big.png");
      ...
      if(ae.getSource()== bbback)
        ...
        h.show();
         ...
         {  
          ...
          CartFC1confirmOrder4 fff = new CartFC1confirmOrder4();
          fff.show();
          this.setVisible(false);
          fff.setVisible(true);
            }
