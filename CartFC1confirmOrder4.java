...
public class CartFC1confirmOrder4 extends JFrame implements ActionListener{
    ...
    public CartFC1confirmOrder4(){
       ...
       // imgsmall.setOpaque(true);
        ...
        imgsmall.setBounds(10,10,50,50);
         ...
         String items[]={"Select Course Type","Available Course","Academic","Admission","Skills",};        
...
Ptop.add(Profile);
     ...
     LMycart.setBackground(Color.decode("#5478E4"));
      Pfront.add(LMycart);
        ...
        ImageIcon minicourse = new ImageIcon("D:\\Final_Biddakosh\\Engineering Admission small.png");
         conl = new JLabel( minicourse);
       conl.setBounds(50, 110,120,70);
        Pfront.add(conl);

        cl1 = new JLabel("<html><p>Engineering Admission<br>Tk. 9500</p></html>");
       ...
       ttt = new JLabel("<html><p align='left'><b>9500/-</b></html>");
...
Pfront.add(bbback);
    ...
    public void actionPerformed(ActionEvent ae)
    {
      if(ae.getSource()==pay )
			{  
        PaymentCourse4 to = new PaymentCourse4();
        to.show();
				to.setVisible(false);
				to.setVisible(true);
