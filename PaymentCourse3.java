...
public class PaymentCourse3 extends JFrame implements ActionListener{
...
Appvar = new JButton("PAY TK. 5000.00");
...
Pfront.add(bbback);
    ...
    {   if (ae.getActionCommand().equals("")) {
      System.out.println( group.getSelection().getActionCommand());
               ...
               if(ae.getSource()==Appvar )
               {  
                 Coursevid3 opoop= new Coursevid3();
                 opoop.show();
                 opoop.setVisible(false);
                 opoop.setVisible(true);
                  }
